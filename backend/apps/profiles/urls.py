...
from .views import CompleteGuideView, InterestDetailView, InterestListCreateView, MeView, SettingsView, ChangePasswordView, PushTokenView
...
urlpatterns = [
    ...
    path("me/push-token/", PushTokenView.as_view(), name="push-token"),
